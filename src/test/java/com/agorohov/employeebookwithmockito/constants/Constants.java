...
public class Constants {
    ...
    public static final String FIRST_NAME_3 = "Сюзанна";

    public static final String LAST_NAME_1 = "Захаров";
    public static final String LAST_NAME_2 = "Орлов";
    public static final String LAST_NAME_3 = "Шмыг";
    ...
    public static final Employee EMPLOYEE_WITH_MIN_SALARY = EMPLOYEE_3;
}
