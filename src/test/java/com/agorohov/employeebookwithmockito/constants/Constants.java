...
public class Constants {
    ...
    public static final String FIRST_NAME_5_ADDED = "Александр";
    ...
    public static final String LAST_NAME_5_ADDED = "Горохов";
    ...
    public static final int SALARY_5_ADDED = 40000;
    ...
    public static final Employee EMPLOYEE_5_ADDED = new Employee(FIRST_NAME_5_ADDED, LAST_NAME_5_ADDED, SALARY_5_ADDED, DEPARTMENT_4_ADDED);
